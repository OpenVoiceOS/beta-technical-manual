...
| `pr_comment` | boolean | `true` | Post a '🏷️ Release Preview' section in the shared 'OVOS PR Checks' comment on the PR. Only runs when a pull_request event triggers the workflow. |
<!-- END GENERATED -->
