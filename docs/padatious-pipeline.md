...
[Padacioso](padacioso.md) (literal, no-model matching) and [Nebulento](nebulento.md) (fuzzy matching) are drop-in replacements that address these limits.
