...
| **GUI Service** | The component (`ovos-gui`) that manages visual displays and [QML](qt5-gui.md)/HTML interfaces. Warning: the current ("legacy") GUI is [deprecated](gui-service.md). There is no usable OVOS GUI. A replacement is in progress. |
