...
| [ovos-tts-plugin-lux](https://github.com/OpenVoiceOS/ovos-tts-plugin-lux) | LuxTTS — zipvoice-based voice-cloning TTS (48 kHz, en-US). *(not yet packaged / no dedicated section — see repo)* | see repo (no license file) | Beta |
