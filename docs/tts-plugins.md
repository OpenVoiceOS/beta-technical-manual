...
| [ovos-tts-plugin-piper](tts-plugins-reference.md#ovos-tts-plugin-piper) | Offline neural TTS with the [Piper](https://github.com/rhasspy/piper) engine. Default TTS on the raspOVOS hybrid/offline images. | Apache-2.0 | Stable |
...
| [ovos-tts-server-plugin](tts-plugins-reference.md#ovos-tts-server-plugin) | OpenVoiceOS companion plugin for [OpenVoiceOS TTS Server](https://github.com/OpenVoiceOS/ovos-tts-server) | Apache-2.0 | Mature |
