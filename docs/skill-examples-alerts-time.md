...
!!! abstract "In a nutshell"
    These skills cover alarms, timers, reminders, the current date and time, and putting the
    assistant to sleep.
...
**Related:** [Utilities](skill-examples-utilities.md) · [Your First Skill](first-skill.md) · [It's not behaving](everyday-help.md)
